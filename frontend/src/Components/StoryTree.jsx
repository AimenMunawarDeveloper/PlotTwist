...
export default function StoryTree({
  ...
  console.log("StoryTree branches:", branches);
  console.log("StoryTree selectedBranch:", selectedBranch);
  return (
      ...
      <div className="relative">
        ...
        <div className="space-y-6">
          {branches.map((branch) => {
            ...
            const isSelected =
              selectedBranch && selectedBranch._id === branchId;
